...
class _PullRequestDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppPage<PullRequestWithDetails?>(
      init: ctrl.init,
        ...
        return DefaultTextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              if (prWithDetails.threads.isNotEmpty) ...[
                SectionHeader(text: 'History'),
                ...prWithDetails.threads.sortedBy((t) => t.publishedDate).reversed.map(
                      (t) => Column(
                        children: [
