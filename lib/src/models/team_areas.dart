...
class TeamAreasResponse {
  TeamAreasResponse({required this.defaultValue, required this.values});
...
class _TeamArea {
  _TeamArea({required this.value, required this.includeChildren});

  factory _TeamArea.fromJson(Map<String, dynamic> json) =>
      _TeamArea(value: json['value'] as String? ?? '', includeChildren: json['includeChildren'] as bool? ?? false);
