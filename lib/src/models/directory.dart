...
class GetDirectoriesResponse {
  ...
  factory GetDirectoriesResponse.fromJson(Map<String, dynamic> json) =>
      GetDirectoriesResponse(data: DataProviders.fromJson(json['dataProviders'] as Map<String, dynamic>? ?? {}));
...
class UserTenant {
  UserTenant({required this.displayName, required this.id, required this.authUrl, this.isCurrent = false});
  ...
  factory UserTenant.current({required String displayName, required String id}) =>
      UserTenant(displayName: displayName, id: id, authUrl: '', isCurrent: true);
...
class User {
  User({required this.name, required this.id, required this.email, required this.tenant});
...
class Tenant {
  Tenant({required this.displayName, required this.id, required this.domain});
