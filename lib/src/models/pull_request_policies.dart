...
class Policy {
  Policy({this.artifactId, this.evaluationId, this.startedDate, this.status, this.completedDate, this.configuration});
  ...
  factory Policy.fromJson(Map<String, dynamic> json) => Policy(
    ...
    completedDate: json['completedDate'] == null ? null : DateTime.parse(json['completedDate']!.toString()).toLocal(),
...
class _PolicyType {
  _PolicyType({required this.id, required this.displayName});

  factory _PolicyType.fromJson(Map<String, dynamic> json) =>
      _PolicyType(id: json['id'] as String? ?? '', displayName: json['displayName'] as String? ?? '');
