...
class TagsResponse {
  ...
  factory TagsResponse.fromJson(Map<String, dynamic> json) =>
      TagsResponse(data: _TagsDataProvider.fromJson(json['dataProviders'] as Map<String, dynamic>));
...
class _TagsDataProvider {
  ...
  factory _TagsDataProvider.fromJson(Map<String, dynamic> json) => _TagsDataProvider(
    tagsData: TagsData.fromJson(json['ms.vss-code-web.commits-data-provider'] as Map<String, dynamic>),
  );
...
class TagsData {
  ...
  factory TagsData.fromJson(Map<String, dynamic> json) => TagsData(
    tags: Map<String, List<dynamic>>.from(json['tags'] as Map<String, dynamic>).map(
      (k, v) => MapEntry<String, List<Tag>>(k, List<Tag>.from(v.map((a) => Tag.fromJson(a as Map<String, dynamic>)))),
    ),
  );
...
class Tag {
  Tag({required this.name, required this.comment, required this.tagger, required this.resolvedCommitId});
...
class _Tagger {
  _Tagger({required this.name, required this.email, required this.date});
