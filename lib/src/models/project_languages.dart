...
class GetProjectLanguagesResponse {
  ...
  factory GetProjectLanguagesResponse.fromJson(Map<String, dynamic> json) => GetProjectLanguagesResponse(
    languageBreakdown: List<LanguageBreakdown>.from(
      (json['languageBreakdown'] as List<dynamic>).map((l) => LanguageBreakdown.fromJson(l as Map<String, dynamic>)),
    ),
    repositoryLanguageAnalytics: List<_RepositoryLanguageAnalytic>.from(
      (json['repositoryLanguageAnalytics'] as List<dynamic>).map(
        (a) => _RepositoryLanguageAnalytic.fromJson(a as Map<String, dynamic>),
      ),
    ),
...
class LanguageBreakdown {
  LanguageBreakdown({required this.name, this.files, this.filesPercentage, this.languagePercentage});
