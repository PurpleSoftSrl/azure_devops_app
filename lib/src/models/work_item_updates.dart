...
class WorkItemUpdatesResponse {
  WorkItemUpdatesResponse({required this.count, required this.updates});
...
class WorkItemUpdate {
  ...
  factory WorkItemUpdate.fromJson(Map<String, dynamic> json) => WorkItemUpdate(
    ...
    relations: json['relations'] == null
        ? null
        : _WorkItemRelations.fromJson(json['relations'] as Map<String, dynamic>),
  );
...
class _Fields {
  ...
  factory _Fields.fromJson(Map<String, dynamic> json) => _Fields(
    ...
    systemState: json['System.State'] == null
        ? null
        : _ChangedField.fromJson(json['System.State'] as Map<String, dynamic>),
    ...
    systemTitle: json['System.Title'] == null
        ? null
        : _ChangedField.fromJson(json['System.Title'] as Map<String, dynamic>),
    ...
    microsoftVstsCommonActivatedBy: json['Microsoft.VSTS.Common.ActivatedBy'] == null
        ? null
        : _RevisedByUpdateValue.fromJson(json['Microsoft.VSTS.Common.ActivatedBy'] as Map<String, dynamic>),
    ...
    microsoftVstsCommonResolvedBy: json['Microsoft.VSTS.Common.ResolvedBy'] == null
        ? null
        : _RevisedByUpdateValue.fromJson(json['Microsoft.VSTS.Common.ResolvedBy'] as Map<String, dynamic>),
...
class _RevisedByUpdateValue {
  _RevisedByUpdateValue({this.newValue, this.oldValue});
...
class _RevisedBy {
  _RevisedBy({this.displayName, this.id, this.uniqueName, this.imageUrl, this.descriptor, this.name});
...
class _MicrosoftVstsCommonPriority {
  _MicrosoftVstsCommonPriority({required this.oldValue, required this.newValue});
...
class _Attributes {
  _Attributes({this.id, this.resourceSize, this.name, this.comment});
...
class LinkUpdate extends ItemUpdate {
  LinkUpdate({required super.updateDate, required super.updatedBy, required this.relations});
...
final class _ChangedField<T> {
  ...
  factory _ChangedField.fromJson(Map<String, dynamic> json) =>
      _ChangedField(oldValue: json['oldValue'] as T?, newValue: json['newValue'] as T?);
